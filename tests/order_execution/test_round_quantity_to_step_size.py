...
def test_round_quantity_to_step_size_negative_step_size():
    ...
    with pytest.raises(ValueError, match="Step size must be greater than or equal to 0."):
        round_quantity_to_step_size(1.23, -0.01)